...
const userSchema = new mongoose.Schema({
    // id: MongoDB automatically provides a unique '_id' field (ObjectId type).
    // We typically use _id as the primary identifier instead of defining our own 'id'.
    ...
    remindertime: {
        // Assuming time stored as a string like "HH:MM". Adjust if needed (e.g., Date or Number)
        type: String,
        match: [/^\d{2}:\d{2}$/, 'Please use HH:MM format for reminder time'] // Basic HH:MM validation
    },
    password: {
        type: String,
