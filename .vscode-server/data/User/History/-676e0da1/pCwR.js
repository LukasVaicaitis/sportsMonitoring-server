...
router.put(
    ...
    async (req, res) => {
        ...
        const { name, dateOfBirth, height, weight, experience, remindertime, activeGymId } = req.body;
        const profileFields = {};
        ...
        if (activeGymId !== undefined) profileFields.activeGymId = activeGymId ? new mongoose.Types.ObjectId(activeGymId) : null;
